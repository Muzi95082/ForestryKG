...
def main_evluacte(_):
    ...
    wordembedding = np.load('./data_forestry/vec.npy')
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for model_iter in testlist:
                ...
                test_word = np.load('./data_forestry/testall_word.npy')
                test_pos1 = np.load('./data_forestry/testall_pos1.npy')
                test_pos2 = np.load('./data_forestry/testall_pos2.npy')
                allprob = []
                acc = []
                ...
                allans = np.load('./data_forestry/allans.npy')

                average_precision = average_precision_score(allans, allprob)
                precision, recall, threshold=precision_recall_curve(allans, allprob)
                sum=0
                sumr=0
                for i in precision:
                    sum=i+sum
...
def main(_):
    ...
    pathname = "./model/ATT_GRU_model-500"

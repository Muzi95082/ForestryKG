...
def init():
    ...
    vec = []
    word2id = {}
    f = open('./nyt_data/vec1.txt', encoding='utf-8')
    ...
    relation2id = {}
    f = open('./nyt_data/relation2id.txt', 'r', encoding='utf-8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    f = open('./nyt_data/train.txt', 'r', encoding='utf-8')
    ...
    f = open('./nyt_data/test.txt', 'r', encoding='utf-8')
    ...
    f = open('./data_nyt/train_q&a.txt', 'w', encoding='utf-8')
    temp = 0
    for i in train_sen:
    ...
    f = open('./data_nyt/test_q&a.txt', 'w', encoding='utf-8')
    temp = 0
    for i in test_sen:
    ...
    np.save('./data_nyt/vec.npy', vec)
    np.save('./data_nyt/train_x.npy', train_x)
    np.save('./data_nyt/train_y.npy', train_y)
    np.save('./data_nyt/testall_x.npy', test_x)
    np.save('./data_nyt/testall_y.npy', test_y)
...
def seperate():
    ...
    x_train = np.load('./data_nyt/train_x.npy')
    ...
    np.save('./data_nyt/train_word.npy', train_word)
    np.save('./data_nyt/train_pos1.npy', train_pos1)
    np.save('./data_nyt/train_pos2.npy', train_pos2)

    print('seperating test all data')
    x_test = np.load('./data_nyt/testall_x.npy')
    test_word = []
    test_pos1 = []
    test_pos2 = []
    ...
    np.save('./data_nyt/testall_word.npy', test_word)
    np.save('./data_nyt/testall_pos1.npy', test_pos1)
    np.save('./data_nyt/testall_pos2.npy', test_pos2)



# get answer metric for PR curve evaluation
def getans():
    test_y = np.load('./data_nyt/testall_y.npy')
    eval_y = []
    for i in test_y:
        eval_y.append(i[1:])
    allans = np.reshape(eval_y, (-1))
    np.save('./data_nyt/allans.npy', allans)


def get_metadata():
    fwrite = open('./data_nyt/metadata.tsv', 'w', encoding='utf-8')
    f = open('./nyt_data/vec1.txt', encoding='utf-8')
    f.readline()
    while True:
